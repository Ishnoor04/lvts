...
const [leaves,setleaves] = useState()
  const getleaves = async() =>{
    let res = await fetch("http://localhost:3001/leaveapi/getleaves", {method:"GET"})
  ...
  const changehandle=async (e,id,email) =>{
    ...
    let res = await fetch("http://localhost:3000/leaveapi/statusupdate", {method:"PUT", body: JSON.stringify({id, status: e.target.value,email}),
     headers: {
